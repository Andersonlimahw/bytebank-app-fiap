...
export const makeDashboardStyles = (theme: AppTheme) =>
  StyleSheet.create({
    ...
    cardValue: { color: theme.colors.cardText, fontSize: 28, fontWeight: '800', marginTop: 6, marginBottom: theme.spacing.md, fontFamily: theme.fonts.bold },
    row: { flexDirection: 'row', alignItems: 'center' },
    smallBtn: { borderRadius: theme.radius.sm, paddingVertical: theme.spacing.sm, paddingHorizontal: theme.spacing.md },
    smallBtnText: { color: theme.colors.cardText, fontWeight: '700', fontFamily: theme.fonts.medium },
    sectionTitle: { fontWeight: '700', fontSize: 16, marginBottom: theme.spacing.sm, marginTop: theme.spacing.xs, color: theme.colors.text, fontFamily: theme.fonts.bold },
    ...
    caption: { color: theme.colors.muted, textAlign: 'center', marginTop: theme.spacing.sm, fontFamily: theme.fonts.regular },
  });
