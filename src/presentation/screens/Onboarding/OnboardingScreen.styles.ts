...
export const onboardingStyles = StyleSheet.create({
  ...
  title: { fontSize: theme.text.h1, fontWeight: '800', textAlign: 'center', color: theme.colors.text },
  subtitle: { fontSize: theme.text.body, color: theme.colors.muted, textAlign: 'center', marginTop: theme.spacing.xs },
