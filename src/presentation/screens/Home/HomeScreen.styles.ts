...
export const makeHomeStyles = (theme: AppTheme) =>
  StyleSheet.create({
    ...
    cardValue: { color: theme.colors.cardText, fontSize: 28, fontWeight: '800', marginTop: 6, fontFamily: theme.fonts.bold },
    signOut: { color: theme.colors.accent, marginTop: theme.spacing.sm, fontFamily: theme.fonts.medium },
    sectionTitle: { fontWeight: '700', fontSize: 16, marginBottom: theme.spacing.sm, color: theme.colors.text, fontFamily: theme.fonts.bold },
