...
export function useDashboardViewModel() {
    const di = useDI();
    const txRepo = useMemo(() => di.resolve(TOKENS.TransactionRepository), [di]);
    const { user } = useAuth();
